...
class BSRoformer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        skip_final_norm=False,  # Skip final RMSNorm layer (for models trained with this option)
        ...
        self.skip_final_norm = skip_final_norm
        ...
        # Final norm (can be skipped for models trained with skip_final_norm=True)
        self.final_norm = RMSNorm(dim) if not skip_final_norm else nn.Identity()
